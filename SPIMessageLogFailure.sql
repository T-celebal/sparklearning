/****** Object:  StoredProcedure [config].[SPIMessageLogFailure]    Script Date: 01-10-2021 15:56:26 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [config].[SPIMessageLogFailure] @ExecutionId UNIQUEIDENTIFIER,@SchemaName varchar(100),@TableName varchar(200),@messagetext varchar(max) AS
/****************************************************************************
**
